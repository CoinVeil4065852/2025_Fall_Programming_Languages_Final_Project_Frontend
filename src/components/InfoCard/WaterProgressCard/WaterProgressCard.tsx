...
// ----------------------------------------------------------------------
// ⬇️ UNCOMMENT THESE IMPORTS IN YOUR REAL PROJECT
import { Card, Group, Stack, Text, Progress, Box, Title, Button } from "@mantine/core";
import InfoCard from "../InfoCard";
// ----------------------------------------------------------------------

// ----------------------------------------------------------------------
// 🛑 MOCK LAYER (DELETE THIS SECTION IN YOUR PROJECT)

/**
 * 💧 WaterTankSvg
 * The standalone SVG component.
 * - Fix: Removed border outline.
 * - Fix: Lighter grey ticks.
 */
const WaterTankSvg = ({
    percentage,
    width = 150,
        ...
        <InfoCard title="Today"   >
            <Group gap="xl" justify="center" align="center"  >
                <Stack >
                    ...
                    <Button variant="light" size="md">Add 250 ml</Button>

                    <Button variant="light" size="md">Add Water</Button>
                </Stack >
                <Box >
                    <WaterTankSvg
                        percentage={percent}
